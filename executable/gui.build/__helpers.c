...
MOD_INIT_DECL( PySimpleGUI$PySimpleGUI );
...
{
    { "PySimpleGUI", MOD_INIT_NAME( PySimpleGUI ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "PySimpleGUI.PySimpleGUI", MOD_INIT_NAME( PySimpleGUI$PySimpleGUI ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "callllama", MOD_INIT_NAME( callllama ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "pkg_resources", NULL, 977123, 95286, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { "pkg_resources._vendor", NULL, 1072409, 145, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { "pkg_resources._vendor.appdirs", NULL, 1072554, 18539, NUITKA_BYTECODE_FLAG },
    { "pkg_resources._vendor.packaging", NULL, 1091093, 519, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { "pkg_resources._vendor.packaging.__about__", NULL, 1091612, 681, NUITKA_BYTECODE_FLAG },
    { "pkg_resources._vendor.packaging._compat", NULL, 1092293, 971, NUITKA_BYTECODE_FLAG },
    { "pkg_resources._vendor.packaging._structures", NULL, 1093264, 2823, NUITKA_BYTECODE_FLAG },
    { "pkg_resources._vendor.packaging.markers", NULL, 1096087, 8831, NUITKA_BYTECODE_FLAG },
    { "pkg_resources._vendor.packaging.requirements", NULL, 1104918, 3836, NUITKA_BYTECODE_FLAG },
    { "pkg_resources._vendor.packaging.specifiers", NULL, 1108754, 19749, NUITKA_BYTECODE_FLAG },
    { "pkg_resources._vendor.packaging.version", NULL, 1128503, 10516, NUITKA_BYTECODE_FLAG },
    { "pkg_resources._vendor.pyparsing", NULL, 1139019, 200896, NUITKA_BYTECODE_FLAG },
    { "pkg_resources._vendor.six", NULL, 1339915, 24346, NUITKA_BYTECODE_FLAG },
    { "pkg_resources.extern", NULL, 1364261, 2360, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { "pkg_resources.py31compat", NULL, 1366621, 616, NUITKA_BYTECODE_FLAG },
    { "pytz", MOD_INIT_NAME( pytz ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "pytz.exceptions", MOD_INIT_NAME( pytz$exceptions ), 0, 0, NUITKA_COMPILED_MODULE },
    { "pytz.lazy", MOD_INIT_NAME( pytz$lazy ), 0, 0, NUITKA_COMPILED_MODULE },
    { "pytz.tzfile", MOD_INIT_NAME( pytz$tzfile ), 0, 0, NUITKA_COMPILED_MODULE },
    { "pytz.tzinfo", MOD_INIT_NAME( pytz$tzinfo ), 0, 0, NUITKA_COMPILED_MODULE },
    ...
    { "tzlocal", MOD_INIT_NAME( tzlocal ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "tzlocal.unix", MOD_INIT_NAME( tzlocal$unix ), 0, 0, NUITKA_COMPILED_MODULE },
    { "tzlocal.win32", MOD_INIT_NAME( tzlocal$win32 ), 0, 0, NUITKA_COMPILED_MODULE },
    { "tzlocal.windows_tz", MOD_INIT_NAME( tzlocal$windows_tz ), 0, 0, NUITKA_COMPILED_MODULE },
