...
static PyObject *const_str_digest_c7b9f78cf43fa8b3dd09557ba6b82cf3;
...
{
    const_str_digest_58e9489883b2042138fb899ca75ed20c = UNSTREAM_STRING( &constant_bin[ 94846 ], 23, 0 );
    const_str_plain_base_str = UNSTREAM_STRING( &constant_bin[ 94869 ], 8, 1 );
    ...
    const_str_digest_c7b9f78cf43fa8b3dd09557ba6b82cf3 = UNSTREAM_STRING( &constant_bin[ 94877 ], 58, 0 );
    const_str_digest_18672d344fa483c179ef434c8fedba1e = UNSTREAM_STRING( &constant_bin[ 94854 ], 14, 0 );
...
static PyCodeObject *codeobj_a0767088995f6e2cfe5786432bbfa6f1;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_c7b9f78cf43fa8b3dd09557ba6b82cf3;
    codeobj_a0767088995f6e2cfe5786432bbfa6f1 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_58e9489883b2042138fb899ca75ed20c, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_a0767088995f6e2cfe5786432bbfa6f1;
    ...
    tmp_assign_source_2 = const_str_digest_c7b9f78cf43fa8b3dd09557ba6b82cf3;
    ...
    // Frame without reuse.
    frame_a0767088995f6e2cfe5786432bbfa6f1 = MAKE_MODULE_FRAME( codeobj_a0767088995f6e2cfe5786432bbfa6f1, module_chardet$compat );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_a0767088995f6e2cfe5786432bbfa6f1 );
    assert( Py_REFCNT( frame_a0767088995f6e2cfe5786432bbfa6f1 ) == 2 );
    ...
    tmp_assign_source_8 = GET_STRING_DICT_VALUE( moduledict_chardet$compat, (Nuitka_StringObject *)const_str_plain_unicode );

    if (unlikely( tmp_assign_source_8 == NULL ))
    {
        tmp_assign_source_8 = GET_STRING_DICT_VALUE( dict_builtin, (Nuitka_StringObject *)const_str_plain_unicode );
    }
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_a0767088995f6e2cfe5786432bbfa6f1 );
#endif
    popFrameStack();

    assertFrameObject( frame_a0767088995f6e2cfe5786432bbfa6f1 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_a0767088995f6e2cfe5786432bbfa6f1, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_a0767088995f6e2cfe5786432bbfa6f1->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_a0767088995f6e2cfe5786432bbfa6f1, exception_lineno );
    }
