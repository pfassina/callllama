...
static PyObject *const_str_digest_b34d8cba1bde482c3e5fe7b516238a63;
...
{
    const_str_digest_014d7364d9b7728f9db9c7c9e73a5813 = UNSTREAM_STRING( &constant_bin[ 375671 ], 15, 0 );
    const_str_digest_b34d8cba1bde482c3e5fe7b516238a63 = UNSTREAM_STRING( &constant_bin[ 375686 ], 59, 0 );
    const_str_digest_96baa068c2199be2cd71dcff3a585dfa = UNSTREAM_STRING( &constant_bin[ 375745 ], 24, 0 );
    const_str_digest_5f28c8ec13a43e2288b9f6b9b20df422 = UNSTREAM_STRING( &constant_bin[ 375769 ], 5, 0 );
    const_str_digest_273bc0eb91233c9ce50bbc2a025b5f82 = UNSTREAM_STRING( &constant_bin[ 375774 ], 179, 0 );
...
static PyCodeObject *codeobj_1d20f27109f94f686b09aaf9bd87c56b;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_b34d8cba1bde482c3e5fe7b516238a63;
    codeobj_1d20f27109f94f686b09aaf9bd87c56b = MAKE_CODEOBJ( module_filename_obj, const_str_digest_96baa068c2199be2cd71dcff3a585dfa, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_1d20f27109f94f686b09aaf9bd87c56b;
    ...
    tmp_assign_source_2 = const_str_digest_b34d8cba1bde482c3e5fe7b516238a63;
    ...
    // Frame without reuse.
    frame_1d20f27109f94f686b09aaf9bd87c56b = MAKE_MODULE_FRAME( codeobj_1d20f27109f94f686b09aaf9bd87c56b, module_chardet$version );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_1d20f27109f94f686b09aaf9bd87c56b );
    assert( Py_REFCNT( frame_1d20f27109f94f686b09aaf9bd87c56b ) == 2 );

    // Framed code:
    tmp_called_instance_1 = GET_STRING_DICT_VALUE( moduledict_chardet$version, (Nuitka_StringObject *)const_str_plain___version__ );

    if (unlikely( tmp_called_instance_1 == NULL ))
    {
        tmp_called_instance_1 = GET_STRING_DICT_VALUE( dict_builtin, (Nuitka_StringObject *)const_str_plain___version__ );
    }

    CHECK_OBJECT( tmp_called_instance_1 );
    frame_1d20f27109f94f686b09aaf9bd87c56b->m_frame.f_lineno = 9;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_1d20f27109f94f686b09aaf9bd87c56b );
#endif
    popFrameStack();

    assertFrameObject( frame_1d20f27109f94f686b09aaf9bd87c56b );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_1d20f27109f94f686b09aaf9bd87c56b, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_1d20f27109f94f686b09aaf9bd87c56b->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_1d20f27109f94f686b09aaf9bd87c56b, exception_lineno );
    }
