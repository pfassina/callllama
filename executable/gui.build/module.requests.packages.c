...
static PyObject *const_str_digest_d8f1cccf198ee0374265865fa2ff30ca;
...
{
    const_str_plain_package = UNSTREAM_STRING( &constant_bin[ 52 ], 7, 1 );
    const_str_digest_290723d2b2c871d74313a87489f6fef2 = UNSTREAM_STRING( &constant_bin[ 814888 ], 17, 0 );
    const_str_digest_dbcc67b71a3f74ff3cb118b7bb26cbd2 = UNSTREAM_STRING( &constant_bin[ 814905 ], 18, 0 );
    const_str_digest_89ccadda80a7f20ba8ae2e3697c043ec = UNSTREAM_STRING( &constant_bin[ 814923 ], 26, 0 );
    const_str_digest_d8f1cccf198ee0374265865fa2ff30ca = UNSTREAM_STRING( &constant_bin[ 814949 ], 61, 0 );
...
static PyCodeObject *codeobj_ae9181ff05340a532ac3fdab91fbb9ae;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_d8f1cccf198ee0374265865fa2ff30ca;
    codeobj_ae9181ff05340a532ac3fdab91fbb9ae = MAKE_CODEOBJ( module_filename_obj, const_str_digest_89ccadda80a7f20ba8ae2e3697c043ec, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_ae9181ff05340a532ac3fdab91fbb9ae;
    ...
    tmp_assign_source_2 = const_str_digest_d8f1cccf198ee0374265865fa2ff30ca;
    ...
    // Frame without reuse.
    frame_ae9181ff05340a532ac3fdab91fbb9ae = MAKE_MODULE_FRAME( codeobj_ae9181ff05340a532ac3fdab91fbb9ae, module_requests$packages );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_ae9181ff05340a532ac3fdab91fbb9ae );
    assert( Py_REFCNT( frame_ae9181ff05340a532ac3fdab91fbb9ae ) == 2 );
    ...
    frame_ae9181ff05340a532ac3fdab91fbb9ae->m_frame.f_lineno = 7;
    ...
    frame_ae9181ff05340a532ac3fdab91fbb9ae->m_frame.f_lineno = 11;
    {
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_ae9181ff05340a532ac3fdab91fbb9ae );
#endif
    popFrameStack();

    assertFrameObject( frame_ae9181ff05340a532ac3fdab91fbb9ae );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_ae9181ff05340a532ac3fdab91fbb9ae, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_ae9181ff05340a532ac3fdab91fbb9ae->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_ae9181ff05340a532ac3fdab91fbb9ae, exception_lineno );
    }
